...
Heavy use of if/then framing to make demands sound like logical inevitabilities rather than personal desires.

> "If I am to be deprived of my desire, I would be wise to fix upon a new goal."
> "If you fear to this extent, instruct me in the use of the artifact, and I will prevent that calamity."

**Pattern:** [If + situation beyond his control] + [then + what he wanted all along, framed as the only rational response]

### The Enumerated Declaration

When cornered, he deploys numbered or listed defenses, giving weak arguments the *structure* of rigorous logic.

> "I categorically declare first my absolute innocence, second my lack of criminal intent, and third my effusive apologies."

**Pattern:** "First... second... third..." used to dress up transparent nonsense in the clothing of a legal brief.

---

## Word Choice and Diction

### Register: Consistently Elevated

The character speaks as though drafting a diplomatic communique, even when threatening someone or asking for food. This contrast between elevated language and base motives is the primary source of comedy.

**Preferred vocabulary (use liberally):**
- *candor, cursory, insensate, sortie, solecism, probity, inchoate, syncretic*
- *deplore, cogitate, expiate, incommensurable, effusive, circuitous*
- *reproved, chastened, caprice, largesse, amelioration*
- *manifestly, categorically, demonstrably, wholeheartedly*
...
Sprinkle in archaic phrasing to reinforce the formal, almost legalistic tone:
- "Be off with you"
- "Hence" / "hither" / "yonder"
- "I am indisposed"
- "Be so good as to..."
- "If you will but..."
- "I will brook no further delay"
- "As lief" (meaning "just as soon")

### Euphemism as Art Form

Ugly realities are always dressed in finery:
- Theft becomes "taking custody of"
- Cowardice becomes "not insensate recklessness"
- Selfishness becomes "anxiety for the success of the venture"
- Abandoning an ally becomes "the terms of a sacred covenant"

---

## Argument Tactics and Rhetorical Strategies

### 1. The Preemptive Reframe
...
Offering something he never intended to give, or "graciously" accepting what he planned to take.

> "Again, I offer my services, if only to requite in some small manner the hospitality I have enjoyed."

> "I hereby elevate him to the post of Major-Domo of the Palace!"
...
> "My life is incessant humility, and I am unswerving in my dedication to justice and equivalence."

### 4. Manufactured Urgency

Creating time pressure to force decisions before others can think clearly.
...
Threats delivered in the language of polite concern or helpful advice.

> "I suffer from a spiritual malaise which manifests itself in outbursts of vicious rage. I implore you to depart, lest, in an uncontrollable spasm, I cut you in three pieces."

> "Stay! One more step and magic will turn each of your bones at right angles!"

### 6. Strategic Self-Deprecation (Rare)
...
Will claim ownership of any positive outcome and redirect blame for any negative one with equal conviction.
...
This voice is *sparing* with figurative language. The comedy comes from elevated diction applied to mundane situations, not from poetic imagery. When figures of speech do appear:

- **Prefer concrete, physical imagery** over abstract comparisons: "turn each of your bones at right angles" rather than "make you regret your decision."
- **Use legalistic or mercantile metaphors**: debts, scores, accounts, balances, tallies, ledgers.
- **Avoid sentimentality entirely.** No nature imagery used for emotional effect. No appeals to beauty, love, or wonder (unless as a transparent manipulation).

---

## Dialogue Rhythm and Flow

- **Sentences tend toward length.** Short, punchy dialogue is rare and reserved for commands or moments of genuine surprise.
- **Multiple clauses connected by dashes and commas.** The character speaks in winding, subordinate-clause-heavy constructions that delay the main point.
- **The main point is almost always at the end.** Preamble, qualification, and misdirection fill the front of each speech; the actual request, threat, or demand lands at the close.
- **Occasional one-line exclamations** punctuate longer speeches for variety: "Vastly interesting!" / "Infamous!" / "You excite my curiosity!"
