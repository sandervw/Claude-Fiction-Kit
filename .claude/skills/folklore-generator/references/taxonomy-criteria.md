...
An association only becomes folklore if it meets ALL THREE:

1. **Connects to something observable or already-believed** - Must have concrete grounding the audience can perceive or accept as premise
2. **Is memorable** - Often through humor, puns, striking imagery, or counterintuitive claims
3. **Serves a function** - Explains phenomena, provides protection, creates group identity, or offers psychological comfort

Associations that fail any criterion die in transmission. When generating, test each candidate against all three.
