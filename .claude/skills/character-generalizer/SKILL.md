...
description: Generalize character elements (actions, descriptions, beliefs, relationships) from specific fictional sources into reusable, setting-agnostic templates. Use when asked to "generalize" character actions or elements, make actions "more general" or "setting-agnostic", create "reusable" character templates, or strip proper nouns from character lists. Triggers include "generalize actions", "make these portable", "strip setting details", "abstract these for reuse".
---
...
| Mode              | Input                                                | Output                               |
| ----------------- | ---------------------------------------------------- | ------------------------------------ |
| **Actions**       | Specific action list (e.g., from character-analysis) | Generalized 5-10 word action phrases |
| **Descriptions**  | _Future expansion_                                   | —                                    |
| **Beliefs**       | _Future expansion_                                   | —                                    |
| **Relationships** | _Future expansion_                                   | —                                    |

Default to Actions mode unless user specifies otherwise.
