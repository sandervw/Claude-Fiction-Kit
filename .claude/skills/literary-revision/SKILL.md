...
description: Revise, rewrite, or redo prose in specific literary styles. Use when user asks to revise text in Howard, Thorogood, Peake, Conan, pulp, gothic, bluesy, barroom, or roadhouse style. Also use for any request to rewrite with a particular voice, tone, or aesthetic.
---
...
|-------|-------|----------|-----------|
| **Thorogood** | Bar-band storyteller, 2nd person, bluesy | Punchy, rhythmic retellings with attitude | [thorogood-style.md](references/thorogood-style.md) |
| **Peake** | Slow gothic camera, animate inanimate | Dense atmospheric description, uncanny mood | [peake-style.md](references/peake-style.md) |
| **Howard** | Pulp heroic, elevated diction | Dramatic adventure prose, visceral action | [howard-style.md](references/howard-style.md) |
